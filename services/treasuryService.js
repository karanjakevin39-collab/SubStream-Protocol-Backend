...
class TreasuryService {
  async getConsolidatedTreasury(merchantId) {
    try {
  ...
  async calculate24hDelta(merchantId, currentValue) {
    try {
  ...
  createEmptyTreasury(merchantId, baseCurrency) {
    return {
      merchantId,
      baseCurrency,
      totalValueLocked: '0',
  ...
  async getTreasuryHistory(merchantId, days = 30) {
    try {
